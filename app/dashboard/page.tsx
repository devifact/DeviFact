        ...
        <div className="flex items-center justify-between mb-8">
          ...
          {isPremium && (
            <div className="flex items-center gap-2 bg-gradient-to-r from-amber-100 to-orange-100 px-4 py-2 rounded-lg border-2 border-amber-300">
              ...
              <span className="text-sm font-bold text-amber-950">Premium Actif</span>
            </div>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-3">
              ...
              <Link
                href="/clients"
                className="block px-4 py-3 bg-sky-50 text-sky-700 rounded-lg hover:bg-sky-100 transition font-medium"
              >
                Ajouter un client
              </Link>
            </div>
          ...
          {isPremium ? (
            <div className="bg-gradient-to-br from-amber-100 to-amber-200 border-2 border-amber-400 rounded-lg shadow-sm p-6">
              <div className="flex items-center gap-2 mb-4">
                <svg className="w-6 h-6 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                </svg>
                <h2 className="text-xl font-semibold text-amber-950">Fonctionnalités Premium</h2>
              </div>
              <div className="space-y-3">
                <Link
                  href="/comptabilite"
